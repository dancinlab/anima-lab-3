...
λ4 RECOMBINATION — 함께 본 적 없는 원자쌍을 다루는가  ★자연 코퍼스 확보로 편입됨
   ...
   ⚠️ 등록한 바의 약점, 실행 후 발견: 통제 폭(broken−seen)이 좁은 모델일수록 중점
      기준을 넘기 쉽다(nat25/50 은 0.22/0.25, nat/natf 은 0.42). 정규위치로 보면
      순서가 같으므로 결론은 살아남지만, 폭 하한을 다음 런부터 구속력 있게
      사전등록해야 한다 — 지금 바를 옮기면 그게 tune-to-green 이다.
